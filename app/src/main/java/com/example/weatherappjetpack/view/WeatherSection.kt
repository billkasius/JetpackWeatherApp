package com.example.weatherappjetpack.view
...
import com.example.weatherappjetpack.constant.Const.Companion.LOADING
import com.example.weatherappjetpack.constant.Const.Companion.NA
import com.example.weatherappjetpack.model.weather.WeatherResult
import com.example.weatherappjetpack.utils.Utils.Companion.buildIcon
import com.example.weatherappjetpack.utils.Utils.Companion.timestampToHumanDate
...
fun WeatherSection(weatherResponse: WeatherResult) {
    ...
    */
    var subTitle = ""
    val dateValue = (weatherResponse.dt ?: 0)
    subTitle = if (dateValue == 0) LOADING
    else timestampToHumanDate(dateValue.toLong(), "dd-MM-yyyy")
